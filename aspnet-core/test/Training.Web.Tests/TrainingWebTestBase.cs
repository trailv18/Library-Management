...
{
    public abstract class TrainingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TrainingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TrainingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TrainingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TrainingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TrainingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TrainingDbContext, Task<T>> func)
        {
            T result;
